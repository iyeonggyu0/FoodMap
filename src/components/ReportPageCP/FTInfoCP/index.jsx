...
const FTInfoCP = forwardRef(
  ({ formData, setFormData, handleInputChange, errors }, refs) => {
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="col-full">
            <div>
              ...
              />
              {errors.intro && (
                <span className="text-red-500 text-sm">{errors.intro}</span>
              )}
            </div>
          </div>
        </div>
        ...
        <ReportPageMenuStyle>
          ...
          <div className="col">
            <div className="menu-list">
              ...
              <div
                className={
                  formData.menu.length === 0 ? "flexCenter" : "flexCol"
                }
              >
              ...
              {errors.menu && (
                <span className="text-red-500 text-sm">{errors.menu}</span>
              )}
            </div>
