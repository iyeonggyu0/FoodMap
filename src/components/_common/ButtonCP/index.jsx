 ...
 */
const ButtonCP = ({ onClick, children, icon, pcOnly = false, color = "--brown-light", fontColor = "--gray-0" }) => {
  const isPc = useMedia().isPc;
  return (
    <ButtonCPStyle pcOnly={pcOnly} media={isPc} color={color} fontColor={fontColor} onClick={onClick}>
